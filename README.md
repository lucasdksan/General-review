...
###  16 - Manipulação de Imagens, Vídeos e Áudio
...
###  22 - Segurança e Criptografia
    - Conceitos básicos de segurança em JavaScript.
    - Criptografia de dados.
    - Proteção contra ataques comuns.
###  23 - WebSockets e Comunicação em Tempo Real
...
###  25 - Integração com Frameworks Front-End
...
###  29 - Deploy e Hospedagem de Aplicações
...
###  30 - Aplicações de Single-Page (SPA)
...
###  36 - Práticas de Desenvolvimento
...
###  37 - Gráficos e Visualização de Dados
...
###  38 - Aprendizado de Máquina em JavaScript
...
###  40 - Progressive Enhancement e Graceful Degradation
...
###  43 - Integração Contínua e Implantação Contínua (CI/CD)
